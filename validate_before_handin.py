#####
##### THIS PROGRAM VALIDATES THE PROGRAMS, TOUR FILES AND PROFORMA BEFORE YOU HAND THEM IN.
##### YOU SHOULD RUN THIS PROGRAM BEFORE HAND-IN.
##### YOU NEED A FOLDER IN WHICH THERE IS:
#####    - THIS PROGRAM
#####    - A FOLDER NAMED WHATEVER YOUR USER-NAME IS, E.G., "abcd12" WITH ALL YOUR TOUR AND PROGRAM FILES IN
...
def build_student_feedback_file(user_name, student_record, programs_to_submit, programs_prefix, tour_files_to_submit,
    ...
    f = open(user_name + "validation_feedback.txt", "w")
